module.exports = {
  ...
  overrides: [
    ...
    {
      // https://github.com/typescript-eslint/typescript-eslint/blob/v4.14.0/packages/eslint-plugin/docs/rules/explicit-function-return-type.md#configuring-in-a-mixed-jsts-codebase
      "files": ["*.ts", "*.tsx"],
      "rules": {
